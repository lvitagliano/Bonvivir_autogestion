...
namespace Bonvivir.Persistence.Migrations
{
    ...
    [Migration("20190329174043_Adds requiered to field of Offer entity")]
    partial class AddsrequieredtofieldofOfferentity
    {
            ...
            modelBuilder.Entity("Bonvivir.Domain.Entities.Offer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "Seed",
                            CreatedDate = new DateTime(2019, 3, 29, 14, 40, 43, 581, DateTimeKind.Local).AddTicks(920),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "Seed",
                            CreatedDate = new DateTime(2019, 3, 29, 14, 40, 43, 581, DateTimeKind.Local).AddTicks(1943),
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = "Seed",
                            CreatedDate = new DateTime(2019, 3, 29, 14, 40, 43, 581, DateTimeKind.Local).AddTicks(1950),
                        ...
                        new
                        {
                            Id = 4,
                            CreatedBy = "Seed",
                            CreatedDate = new DateTime(2019, 3, 29, 14, 40, 43, 581, DateTimeKind.Local).AddTicks(1957),
                        ...
                        new
                        {
                            Id = 5,
                            CreatedBy = "Seed",
                            CreatedDate = new DateTime(2019, 3, 29, 14, 40, 43, 581, DateTimeKind.Local).AddTicks(1964),
                        ...
                        new
                        {
                            Id = 6,
                            CreatedBy = "Seed",
                            CreatedDate = new DateTime(2019, 3, 29, 14, 40, 43, 581, DateTimeKind.Local).AddTicks(1971),
