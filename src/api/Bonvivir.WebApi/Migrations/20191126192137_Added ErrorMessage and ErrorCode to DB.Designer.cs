...
namespace Bonvivir.WebApi.Migrations
{
    ...
    [Migration("20191126192137_Added ErrorMessage and ErrorCode to DB")]
    partial class AddedErrorMessageandErrorCodetoDB
    {
            ...
            modelBuilder.Entity("Bonvivir.Domain.Entities.Offer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "Seed",
                            CreatedDate = new DateTime(2019, 11, 26, 16, 21, 37, 620, DateTimeKind.Local).AddTicks(9522),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "Seed",
                            CreatedDate = new DateTime(2019, 11, 26, 16, 21, 37, 621, DateTimeKind.Local).AddTicks(27),
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = "Seed",
                            CreatedDate = new DateTime(2019, 11, 26, 16, 21, 37, 621, DateTimeKind.Local).AddTicks(34),
                        ...
                        new
                        {
                            Id = 4,
                            CreatedBy = "Seed",
                            CreatedDate = new DateTime(2019, 11, 26, 16, 21, 37, 621, DateTimeKind.Local).AddTicks(36),
                        ...
                        new
                        {
                            Id = 5,
                            CreatedBy = "Seed",
                            CreatedDate = new DateTime(2019, 11, 26, 16, 21, 37, 621, DateTimeKind.Local).AddTicks(38),
                        ...
                        new
                        {
                            Id = 6,
                            CreatedBy = "Seed",
                            CreatedDate = new DateTime(2019, 11, 26, 16, 21, 37, 621, DateTimeKind.Local).AddTicks(39),
