      ...
      <div class="modal-mask">
        <div class="modal-wrapper">
          <div class="modal-container">
             <form @submit.prevent="agregar(talentos,invita2,precioFinal)">
            ...
            <div class="modal-body ml-n5 mr-n5" style="width:100%; padding: 0; margin:0;">
              ...
              <ul>
                ...
                <li>
                  Imágen cargada de transferencia:
                  <b>{{imagenTransferencia.name}}</b>
                </li>
                <li>
            ...
            <div class="modal-footer" style="margin-right: -20px;">
              <slot name="footer m-4">
                <button class="btn btn-sm btn-danger" @click="ocultaModalPago()">
                  <i class="mr-1 fa fa-times-circle"></i> Cancelar
                </button>
                <a href="/mis-proyectos" class="btn btn-sm btn-success" @click="agregar();ocultaModalPago();">
...
export default {
    ...
    return {
      ...
      computed: {
     ...mapState(["talentos", "invita2", "precioFinal", "showModalPago", "imagenTransferencia"]),
  },
   created() {
  ...
  methods: {
      ...
      "ocultaModalPago"
        ...
        axios.post("/pagosPlanes", this.datos, this.configuracion).then(res => {
