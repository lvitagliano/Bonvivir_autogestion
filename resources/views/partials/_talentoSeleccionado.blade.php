        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
               <div class="card card-profile">
                ...
                <div class="card-body">
                  <h4 class="card-title">Talento {{$deseado->Talentos->id}}</h4>
                  <h6 class="card-category text-muted">{{$deseado->Talentos->Talentos->Talento1->nombre}} | {{$deseado->Talentos->Talentos->Talento2->nombre}}</h6>
                ...
                <div class="card-footer justify-content-center">
                     <!--  <div class="togglebutton">
                          <label>
                              <input type="checkbox" class="me_caigo_select"
...
$('.me_caigo_select').click(function(e, parameters) {
