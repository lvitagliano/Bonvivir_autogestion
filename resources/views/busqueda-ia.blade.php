...
<div class="main main-raised bkg-ind">
  <div class="profile-content">
    <div class="container">
      ...
      <div class="row">         
         <div class="col-md-4 ml-auto mr-auto" style="margin-top: -100px"> 
            <img src="{{ asset('img/'.$img_path) }}" id="Image"  width="400px"  name="Image" />
          </div> 
        <div class="col-md-8 ml-auto mr-auto" style="margin-top: -100px">
